...
public class EsConfig {
  ...
  public String getHost() {
    return ConfigurationAccessor.getPluginProperty(SdkConstants.TSUZAMMEN_SEARCH_INDEX, host);
  }

  public int getTransportPort() {
    String port =
        ConfigurationAccessor.getPluginProperty(SdkConstants.TSUZAMMEN_SEARCH_INDEX, transportPort);
    return Integer.parseInt(port);
  }

  public String getClusterName() {
    return ConfigurationAccessor
        .getPluginProperty(SdkConstants.TSUZAMMEN_SEARCH_INDEX, clusterName);
  }
}
